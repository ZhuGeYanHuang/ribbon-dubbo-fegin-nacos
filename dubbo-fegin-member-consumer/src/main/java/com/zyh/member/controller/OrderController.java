...
import com.zyh.member.api.OrderApi;
...
public class OrderController {
    ...
    private JSONObject getOrderListOLd(@PathVariable("memberId") String memberId) {
        JSONObject object = orderApi.getList(memberId);
    ...
    @RequestMapping(value = "getOrderList/memberId1/{memberId}")
